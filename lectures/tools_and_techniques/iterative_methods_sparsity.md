...
tags: [hide-output]
---
using Pkg; haskey(Pkg.project().dependencies, "Plots") || Pkg.add(["Arpack", "BenchmarkTools", "IncompleteLU", "IterativeSolvers", "LaTeXStrings", "LinearMaps", "Plots", "Preconditioners"])
